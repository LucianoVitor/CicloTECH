      ...
      <nav className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            <span className="font-data font-bold tracking-tighter text-foreground text-lg">CICLO TECH</span>
          </Link>
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`text-xs font-data uppercase tracking-widest transition-colors duration-200 ${
                  location.pathname === link.path ? "text-accent" : "text-muted-foreground hover:text-accent"
                }`}
              >
                {link.label}
              </Link>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <span className="font-data font-bold tracking-tighter text-foreground">CICLO TECH</span>
              </div>
